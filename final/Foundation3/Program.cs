...
public class Program
{
    ...
    {
        var address1 = new Address("1642 West Bengal Street", "Shelby", "Idaho", "US");
        var address2 = new Address("150 South Temple Street", "Youragway", "Washington State", "US");
        var address3 = new Address("6583 Moe Dans Ha Circle", "C'esta", "Utah", "US");
        ...
        var outdoor = new Outdoor("Neighborhood Lunch at Ron's House!", "12:30 PM", "Come eat some yummy food at the Featherson's house! Sandwitches, chips and soda provided.", address3, new DateTime(2024, 7, 14), "Mostly Sunny, 75°");
